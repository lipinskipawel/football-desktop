...
class GamePanel extends JPanel {
    ...
    private static String staticText1vs1() {
        return "In this mode you can play 1 vs 1 in one \n" +
                "computer. Invite your friend and try to \n" +
                "win a game. Rules are really simple, try to score a goal by putting ball into enemy \n" +
                "goal area.";
    }
    private static String staticText1vsLAN() {
        return "In this mode try to win with your friend \n" +
    ...
    private static String staticText1vsAI() {
        return "In this mode you will be faced of AI.\n" +
                "This is powerful tool which can beat you.\n" +
                "Try to win with it. In future this AI will be \n" +
                "working as Neural Network. \n" +
                "Good luck";
    }
    ...
    void addButtonConnectListener(final ActionListener listener) {this.buttonSouth.addActionListener(listener);}
